...
+ (QLCoreTextLink *)linkAtIndex:(CFIndex)i linkArray:(NSArray *)linkArray {
    QLCoreTextLink *link = nil;
    for (QLCoreTextLink *data in linkArray) {
